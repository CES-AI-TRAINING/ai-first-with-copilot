...
- [Java Copilot Labs](./java-copilot-labs.md)
...
1. Read the objectives and acceptance criteria for each task.
2. Use the example prompts as starting points for interacting with Copilot.
3. Iterate — ask Copilot to write tests, refactor, or provide explanations.
4. Record notes about which prompts produced the best results and any follow-up prompts that were helpful.
